...
> 2026-08-20 更新——问题 1、2 均已实施并经真机验证（随 c19c901 / v0.5.0 落地），仅问题 3 待确认。
...
> 问题 1、2 已通过文件日志确认根因并经真机验证闭环（2026-08-20）。仅剩问题 3 待确认。

- 用已落盘的文件日志（关键字见下方埋点表）确认问题 3 的时间线：
  - 上一次 socket 关闭时刻（约 30 秒心跳超时）与 KICKED 到达时刻是否紧挨重连成功那一刻。
- **根因经日志确认后**再实施问题 3 候选方案（KICKED 后有限次重试，见「问题 3」一节）。
