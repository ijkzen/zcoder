...
Out of scope for v1: model selection when creating sessions, usage/billing UI, browser control, terminal panel (xterm), Z.AI account login. The conversation UI is the product.
